...
| error           | failures such as a rejected sync, never a lane decision | #b3261e |
...
| error-dark      | failures on dark                                        | #f2847a |
...
| ------- | ---------------- | ------ | ---- | ----------- |
| display | Charter          | 700    | 30px | 33px        |
| heading | Charter          | 700    | 24px | 30px        |
| body    | Ubuntu Sans      | 400    | 15px | 22px        |
| label   | Ubuntu Sans      | 400    | 12px | 16px        |
| code    | Ubuntu Sans Mono | 400    | 15px | 22px        |
